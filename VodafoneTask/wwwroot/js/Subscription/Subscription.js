...
function onClickSubscribe() {
    if ($("#Frequency").val() != "1" && $("#Frequency").val() != "2" && $("#Frequency").val() != "3") {
        $("#AlertMessage").text("Choose Frequency");
        $("#AlertMessage").show();
        return;
    } else if ($("#StartDate").val().toString().trim() == "") {
        $("#AlertMessage").text("Wrong Start Date");
        $("#AlertMessage").show();
        return;
    } else if ($("#ReportTime").val().toString().trim() == "") {
        $("#AlertMessage").text("Wrong ReportTime");
        $("#AlertMessage").show();
        return;
    } 
    else {
